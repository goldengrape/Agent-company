...
class ContextBuilder:
    ...
    def get_agent_identity(self, post_id: str) -> str:
        """
        Get the specific identity prompt for a given Post ID.
        
        Args:
            post_id: The ID of the post (from POSTS.md).
            
        Returns:
            A system prompt customized for this post.
        """
        # Ensure company config is loaded
        ...
        post_identity = f"""# Agent Identity: {post.title}
...
{skills_summary}""")
    ...
    def _get_runtime_info(self) -> str:
        """Get standard runtime information block."""
...
Your workspace is at: {workspace_path}"""
    ...
    def _get_identity(self) -> str:
        """Get the core identity section (Default Nanobot)."""
        runtime_info = self._get_runtime_info()
        workspace_path = str(self.workspace.expanduser().resolve())
